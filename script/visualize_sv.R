...
plot_lineage_tree <- function(infile){
  ...
  ncolor = rep("lightblue", length(V(tree)))
  # ncolor[match(dead_nodes, tnodes)]="lightblue"
  # ncolor[match(curr_nodes, tnodes)]="red"
...
plot_chr <- function(SV, t, fplot){
  ...
  colfunc2<-colorRampPalette(c('#d0d1e6','#045a8d'))
  ...
  colgrad=5
  text(xmax+maxt*10000000 - 105000000, 122, "A",cex=1.5)
  text(xmax+maxt*10000000 - 125000000, 122, "B",cex=1.5)
